  ...
  return (
    <section className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        {/* Google Colors Floating Elements */}
        <div className="absolute top-20 left-10 w-40 h-40 bg-blue-500/8 rounded-full blur-2xl animate-pulse"></div>
        <div className="absolute top-40 right-20 w-32 h-32 bg-red-500/8 rounded-full blur-2xl animate-pulse delay-1000"></div>
        <div className="absolute bottom-40 left-20 w-36 h-36 bg-yellow-500/8 rounded-full blur-2xl animate-pulse delay-2000"></div>
        <div className="absolute bottom-20 right-10 w-44 h-44 bg-green-500/8 rounded-full blur-2xl animate-pulse delay-3000"></div>
        
        {/* Additional Geometric Elements */}
        <div className="absolute top-1/3 left-1/4 w-2 h-2 bg-blue-400/30 rounded-full animate-ping"></div>
        <div className="absolute top-2/3 right-1/3 w-1 h-1 bg-red-400/30 rounded-full animate-ping delay-500"></div>
        <div className="absolute bottom-1/3 left-1/3 w-1.5 h-1.5 bg-yellow-400/30 rounded-full animate-ping delay-1000"></div>
        <div className="absolute top-1/2 right-1/4 w-2 h-2 bg-green-400/30 rounded-full animate-ping delay-1500"></div>
      ...
      <div className="relative z-10 container mx-auto px-6 py-16 flex flex-col lg:flex-row items-center min-h-screen gap-12">
        ...
        <div className="lg:w-1/2 space-y-10">
          ...
          <div className="inline-flex items-center space-x-3 bg-gray-800/60 backdrop-blur-sm px-6 py-3 rounded-full border border-gray-700/50">
            ...
            <span className="text-sm font-medium text-gray-300">AI-Powered Marketing Expert</span>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              <p className="text-xl lg:text-2xl text-gray-300 leading-relaxed max-w-2xl">
                Scaling Brands with <span className="text-yellow-400 font-semibold">Data-Driven Marketing</span> & 
                <span className="text-red-400 font-semibold"> Google Ads Mastery</span>
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-6">
            <div className="bg-gray-800/40 backdrop-blur-sm border border-gray-700/50 rounded-xl p-6 text-center hover:border-blue-500/50 transition-all duration-300">
              ...
              <div className="text-sm text-gray-400 font-medium">Clients Served</div>
            </div>
            ...
            <div className="bg-gray-800/40 backdrop-blur-sm border border-gray-700/50 rounded-xl p-6 text-center hover:border-red-500/50 transition-all duration-300">
              ...
              <div className="text-sm text-gray-400 font-medium">ROAS Achiever</div>
            </div>
          </div>

          {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row gap-6">
            <button className="group bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white px-8 py-4 rounded-xl font-semibold transition-all duration-300 transform hover:scale-105 flex items-center justify-center space-x-3 shadow-lg shadow-blue-500/25">
              <Eye className="w-5 h-5" />
              <span>View Case Studies</span>
              <ChevronRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
            </button>
            <button className="group bg-gray-800/60 backdrop-blur-sm hover:bg-gray-700/60 text-white px-8 py-4 rounded-xl font-semibold transition-all duration-300 border border-gray-600/50 hover:border-gray-500 flex items-center justify-center space-x-3">
          ...
          <div className="inline-flex items-center space-x-3 text-sm text-gray-400 bg-gray-900/40 backdrop-blur-sm px-4 py-2 rounded-lg border border-gray-700/30">
            ...
            <span>This site was built using AI — because I believe in it.</span>
          </div>
        </div>
        ...
        <div className="lg:w-1/2 relative">
          <div className="relative max-w-lg mx-auto">
            ...
            <div className="absolute -top-6 -right-6 bg-gradient-to-r from-red-500 to-red-600 text-white p-4 rounded-full animate-bounce shadow-lg shadow-red-500/30">
              <Award className="w-6 h-6" />
            </div>
            <div className="absolute -bottom-6 -left-6 bg-gradient-to-r from-yellow-500 to-yellow-600 text-black p-4 rounded-full animate-pulse shadow-lg shadow-yellow-500/30">
              <Brain className="w-6 h-6" />
            </div>
            <div className="absolute top-1/2 -left-4 bg-gradient-to-r from-green-500 to-green-600 text-white p-3 rounded-full animate-ping shadow-lg shadow-green-500/30">
